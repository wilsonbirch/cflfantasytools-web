...
export type JobHealthQuery = { __typename?: 'Query', jobHealth: Array<{ __typename?: 'JobHealth', kind: string, ageMinutes?: number | null, expectedEveryMinutes: number, isStale: boolean, lastSuccessAt?: string | null }> };
